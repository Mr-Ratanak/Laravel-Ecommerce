...
<div class="card"> 
  ...
  <div class="header"> 
    <div class="image">
      ...
      <div class="content">
         <span class="title">@if (session('message'))
             {{session('message')}}
         @endif</span> 
         <p class="message">Thank you for your purchase. you package will be delivered soon.</p> 
         </div> 
         <div class="actions">
            <button type="button" class="history">History</button>  
            <a href="{{url('/collection')}}" class="track text-decoration-none">Make Order</a>
            </div> 
            </div> 
            </div>
