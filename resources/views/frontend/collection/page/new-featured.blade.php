...
<div class="row">
    <div class="col-md-12">
        <div class="welcome-page">
            <h2 class="text-center py-2">Explore various featured <span class="text-warning">KH-Ecommerce</span> 
            ...
            <div class="trending">
                <h3>New Featured <div class="underline"></div></h3>
            </div>
        </div>
    </div>
</div>
<div class="row mx-4 mt-4 ">
        @forelse ($newFeatured as $productItem)
